                    ...
                    foreach ($result as $student) { ?>
                        <tbody>
                            <tr class="fst-normal">
                                ...
                                <td>
                                        <a role="button" href="edit.php?id=<?php echo $student['_id']; ?>" name="edit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                    ...
                                    <td>
                                        <a onclick="return confirm('Do you want to delete this student?');" href = "delete.php?id=<?php echo $student['_id']; ?>" role="button" name="delete">
